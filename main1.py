...
from loss import LabelSmoothingCrossEntropy, get_mmd_loss, MMCE_weighted
from model.baseline_eight import InfoGCN
...
class Processor():
    ...
    def load_model(self):
        ...
        self.loss1 = MMCE_weighted(device=torch.device(0))
    ...
    def train(self, epoch, save_model=False):
        ...
        for data, y, index in tqdm(self.data_loader['train'], dynamic_ncols=True):
            ...
            cls_loss1 = self.loss(y_hat, y)
            cls_loss2 = self.loss1(y_hat, y)


            cls_loss = 0.9 * cls_loss1 + 0.1 * cls_loss2
...
def main():
    ...
    arg.work_dir = f"infogcn_hdgcn/ntuss/b/{arg.dataset}_{arg.datacase}"
    init_seed(arg.seed)
    # execute process
