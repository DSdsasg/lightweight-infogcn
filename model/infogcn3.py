...
class InfoGCN(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, in_channels=3,
        ...
        self.l2 = EncodingBlock(base_channel, base_channel*2, A, stride=2)
        self.l3 = EncodingBlock(base_channel*2, base_channel*4, A, stride=2)
        self.l4 = EncodingBlock(base_channel*4, base_channel*4, A)
